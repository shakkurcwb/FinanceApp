...
(() => {
/*!***************************************************!*\
  !*** ./resources/js/components/account-graphs.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! chart.js/auto */ "./node_modules/chart.js/auto/auto.js");

var ctxBalance = document.getElementById('account-balance-chart');
new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctxBalance, {
  type: 'pie',
  data: {
...
var ctxTypes = document.getElementById('transaction-types-chart');
var labels = transactions_breakdown.map(function (item) {
  return item.type;
});
var data = transactions_breakdown.map(function (item) {
  return item.total;
});
new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctxTypes, {
  type: 'pie',
  data: {
    labels: labels,
    datasets: [{
      ...
      data: data,
      backgroundColor: ['rgb(255, 99, 132)', 'rgb(54, 162, 235)', 'rgb(255, 205, 86)', 'rgb(75, 192, 192)', 'rgb(153, 102, 255)', 'rgb(255, 159, 64)', 'rgb(201, 203, 207)', 'rgb(123, 31, 162)', 'rgb(54, 162, 235)', 'rgb(255, 205, 86)', 'rgb(75, 192, 192)'],
      hoverOffset: 4
    }]
  }
});
